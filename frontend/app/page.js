...
const steps = [
  {
    no: '01',
    title: '種下一個習慣',
    desc: '選一件想改變的事，寫下你想抵達的目標，決定要陪它走幾週。例如：八週的「規律運動」，目標是連續慢跑 5 公里。',
  },
  {
    no: '02',
    title: '安排這週的任務',
...
const features = [
  {
    ...
    title: '連續達標',
    desc: '每週完成 85% 的計畫，連續紀錄就會一直延續。不必完美，持續就是勝利。',
  },
  {
    Icon: PiCheckBold,
...
const faqs = [
  ...
  {
    q: '「連續達標」是怎麼計算的？',
    a: '每週結算一次：只要完成當週計畫的 85%，這週就算達標，連續週數就繼續累積。不要求完美，持續執行比偶爾滿分更重要。',
  },
  {
    q: '忘記打卡怎麼辦？',
